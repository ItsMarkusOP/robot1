...
LOGGER.debug("[CUTIEPII]: Connecting To Yūki • Data Center • Mumbai • MongoDB Database")
...
LOGGER.debug("[CUTIEPII]: Connecting To Yūki • Data Center • Mumbai • PostgreSQL Database")
ubot = TelegramClient(StringSession(STRING_SESSION), APP_ID, APP_HASH)
LOGGER.debug("[CUTIEPII]: Connecting To Yūki • Cutiepii Userbot (https://telegram.dog/Awesome_Cutiepii)")
timeout = Timeout(40)
