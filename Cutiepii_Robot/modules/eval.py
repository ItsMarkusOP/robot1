...
from Cutiepii_Robot import LOGGER, application
...
async def evaluate(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if os.path.isfile("Cutiepii_Robot/modules/helper_funcs/temp.txt"):
        os.remove("Cutiepii_Robot/modules/helper_funcs/temp.txt")
