"""
Telegraph module to upload text and image/video to telegra.ph via Cutiepii_Robot
...
from Cutiepii_Robot import TEMP_DOWNLOAD_LOC, application
...
async def telegraph(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    r = await telegrph.create_account(short_name="Cutiepii_Robot")
    auth_url = r["auth_url"]
